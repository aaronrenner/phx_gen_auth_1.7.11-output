defmodule SampleAppWeb.Router do
  ...
  if Application.compile_env(:sample_app_web, :dev_routes) do
  ...
  scope "/", SampleAppWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SampleAppWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SampleAppWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SampleAppWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", SampleAppWeb do
    ...
    live_session :current_user,
      on_mount: [{SampleAppWeb.UserAuth, :mount_current_user}] do
